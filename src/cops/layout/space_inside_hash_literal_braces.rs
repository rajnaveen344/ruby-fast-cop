...
struct Cfg {
    ...
    enforced_style_for_empty_braces: String,
}
impl Default for Cfg {
    fn default() -> Self {
        Self {
            enforced_style: "space".into(),
            enforced_style_for_empty_braces: "no_space".into(),
        }
    }
}

crate::register_cop!("Layout/SpaceInsideHashLiteralBraces", |cfg| {
    let c: Cfg = cfg.typed("Layout/SpaceInsideHashLiteralBraces");
    ...
    let empty_style = match c.enforced_style_for_empty_braces.as_str() {
