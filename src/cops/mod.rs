...
pub fn all() -> Vec<Box<dyn Cop>> {
    vec![
        ...
        Box::new(lint::EmptyInterpolation::new()),
        ...
        Box::new(lint::UnreachableLoop::new()),
        ...
        Box::new(layout::ClosingParenthesisIndentation::new(2)),
        Box::new(layout::IndentationConsistency::new(layout::IndentationConsistencyStyle::Normal)),
        ...
        Box::new(layout::EmptyLinesAroundBeginBody::new()),
        Box::new(layout::EmptyLinesAroundBlockBody::new(layout::EmptyLinesAroundBlockBodyStyle::NoEmptyLines)),
        Box::new(layout::EmptyLinesAroundClassBody::new(layout::EmptyLinesAroundClassBodyStyle::NoEmptyLines)),
        Box::new(layout::EmptyLinesAroundExceptionHandlingKeywords::new()),
        Box::new(layout::EmptyLinesAroundMethodBody::new()),
        Box::new(layout::EmptyLinesAroundModuleBody::new(layout::EmptyLinesAroundModuleBodyStyle::NoEmptyLines)),
        Box::new(layout::BeginEndAlignment::new(layout::BeginEndAlignmentStyle::StartOfLine)),
        Box::new(layout::BlockAlignment::new(layout::BlockAlignmentStyle::Either)),
        Box::new(layout::CaseIndentation::new()),
        Box::new(layout::DefEndAlignment::new(layout::DefEndAlignmentStyle::StartOfLine)),
        Box::new(layout::ElseAlignment::new()),
        Box::new(layout::EndAlignment::new(layout::EndAlignmentStyle::Keyword)),
        Box::new(layout::ExtraSpacing::new()),
        ...
        Box::new(layout::SpaceBeforeFirstArg::new()),
        ...
        Box::new(layout::SpaceInsideStringInterpolation::default()),
        ...
        Box::new(style::ClassEqualityComparison::new()),
        ...
        Box::new(style::MethodDefParentheses::new(style::MethodDefParenthesesStyle::RequireParentheses)),
        Box::new(style::MultipleComparison::new()),
        Box::new(style::MutableConstant::new(style::MutableConstantStyle::Literals)),
        Box::new(style::NegatedIf::new()),
        Box::new(style::NegatedUnless::new()),
        Box::new(style::NegatedWhile::new()),
        Box::new(style::NegativeArrayIndex::new()),
        Box::new(style::Next::new()),
        ...
        Box::new(style::TrivialAccessors::new()),
        Box::new(style::VariableInterpolation::new()),
        Box::new(style::WhileUntilModifier::new()),
        Box::new(style::WordArray::default()),
